...
/// </summary>
void ShortRange::fire(Entity& entity, GamePlay& game)
{
	...
	game.spawnProjectile(&entity, entity.getPosition(),facingDirection,m_stats->getProjSpeed(), m_stats->getDamage(), m_stats->getRange(), 1);
}
