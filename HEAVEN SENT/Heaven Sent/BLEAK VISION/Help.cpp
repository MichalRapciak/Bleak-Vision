...
void Help::initialise(sf::Font& t_font)
{
	...
	m_helpText.setString("Use WASD to move around \nPress Shift to sprint\nPress Space to spin/dodge\nPress 1/2/3/4 to select Melee hits or Short/Medium/Long Spells\nMouse Click to attack, Use mouse to aim\nPress Esc to pause and access Skill Upgrades\nDuring the game\n(or to return to the Main Menu now)");
